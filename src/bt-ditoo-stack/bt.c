...
void bt_client_task(__unused void* param) {
        ...
        case TC_W4_SERVICE_RESULT:
            switch (hci_event_packet_get_type(packet)) {
                ...
                case GATT_EVENT_QUERY_COMPLETE:
                    ...
                    printf("Search for env sensing characteristic.\n");
        ...
        case TC_W4_CHARACTERISTIC_RESULT:
            switch (hci_event_packet_get_type(packet)) {
                ...
                case GATT_EVENT_QUERY_COMPLETE:
                    ...
                    printf("Enable notify on characteristic.\n");
...
static void hci_event_handler(uint8_t packet_type, __unused uint16_t channel, __unused uint8_t* packet, uint16_t size) {
